...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About NEET Expert — Senior Mentors, Not a Call Centre" },
      ...
      { property: "og:title", content: "About NEET Expert" },
...
function AboutPage() {
  return (
    <PageShell
      ...
      subtitle="NEET Expert is a boutique counselling firm run by senior mentors who have personally guided thousands of students into India's most competitive medical seats."
    >
      <About />
      <WhyUs />
    </PageShell>
