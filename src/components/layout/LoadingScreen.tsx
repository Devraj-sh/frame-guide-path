  ...
  return (
    ...
    >
      <div className="relative h-32 w-32">
        ...
        <img src={logoAsset.url} alt="NEET Expert" className="absolute inset-4 h-24 w-24 object-contain" />
      </div>
      <p className="mt-8 font-display text-2xl font-bold text-white">NEET Expert</p>
